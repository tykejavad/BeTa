 ...
 (function(a) {
    ...
    d.prototype = {
        ...
        _exportToImage: function(c, d) {
            ...
            if (c.fileName) b.fileName = c.fileName;
            else switch (b.type) {
                case "image/jpeg":
    ...
    k.prototype.render = function(a, l) {
        ...
        if (e <= 0 || d <= 0) return;
        if (this.cornerRadius == 0) k.renderRectPath(a, f, g, e, d);
    ...
    vb.prototype.toJSON = function() {
        var a = this,
            b = "type:'pieSlice',x:" + a.x + ",y:" + a.y + ",radius:" + a.radius + ",startAngle:" + a.startAngle + ",endAngle:" + a.endAngle;
        b += c.prototype.toJSON.call(this);
        return b
    };
    ...
    l.prototype.renderText = function(b, c, a) {
        ...
        if (h) {
            var g = this.text.split(l.separator),
                d = this.getHeight(),
                e;
    ...
    l.prototype.measure = function(e) {
        ...
        var c = this.getHeight(),
            a, b, g = this.text && this.text.search(l.separator) != -1;
        if (g) {
    ...
    Kb.prototype.mouseWheel = function(d, c) {
        ...
        for (var b = 0; b < a.length; b++)
            if (this.view.options.mouseWheelInteractionMode == "scrolling") a[b]._mouseWheelScroll(c);
    ...
    e.prototype._setOptions = function(h) {
        ...
        else this.elem.width() == 0 && this.elem.css("width", "400px"); if (g.height) this.elem.css("height", g.height);
    ...
    e.prototype._getTooltipShapes = function(h, i, g, c) {
        ...
        } else b = d.prototype._getTooltipShapes.call(this, h, i, g, c); if (b) {
    ...
    kb.prototype._measure = function() {
        ...
        var n = 2 * this.margin + e.left + e.right,
            o = 2 * this.margin + e.top + e.bottom,
            j = this.chart.border.getPaddings(),
            l = this.chart._width - j.left - j.right - n;
        if (k && b > l) {
            var f = Math.floor(l / d) || 1,
                m = Math.ceil(this.items.length / f);
            this.rows = f;
    ...
    kb.prototype._arrange = function() {
        ...
        for (var i = this._isHorizontal(), f = this.rows, d = 0; d < this.items.length; d++) {
            ...
            if (i)
                ...
                } else e += a.width + this._itemMargin;
            else b += a.height;
            a._arrange()
        }
    };
    ...
    f.prototype = {
        ...
        _addMarkerAndLabel: function(i, p, l, m, a, k, g, e, o, c) {
            ...
            if (this.markers && this.markers.isVisible() && this.realYAxis.isValueVisible(e)) {
                var n = c.dataItem[2],
                    d = this._addMarker(l, m, null, e, n, a, c);
                if (d.marker) {
        ...
        _calcVisibleStackedData: function(s, w, u) {
            if (this.realYAxis.zoomEnabled) return;
            var e = this.realXAxis,
                i = e.visibleMinimum || e.minimum,
                h = e.visibleMaximum || e.maximum,
                l = !b.isNull(i),
                k = !b.isNull(h);
            if (!l && !k) return;
            if (e.skipEmptyDays) {
        ...
        _getPixelMargins: function(d) {
            ...
            else b = e.width / 2 + c.width + g; if (k && !f || !k && f) {
                b += h;
                b *= 1.25;
                var m = b / d.length;
                b *= 1 + m
    ...
    h.prototype._createLabels = function() {
        ...
        for (var k, y, p = [], o = b.radians(this.startAngle), z = this.labelsPosition == "outside", u = this.hiddenSlices, F = D - u.length, n = 0, d = 0; d < D; d++) {
            ...
            else k = this._getSliceCenter(h, i, e, g * .6);
            c.x = k.x - C.width / 2;
            c.y = k.y - C.height / 2;
            o = x;
    ...
    h.prototype._arrangeLabels = function(c) {
        ...
        var s = [],
            d, g, k, p, h, i, l = this.explodedRadius;
    ...
    h.prototype._calcRadius = function(b) {
        var f = b.v || this.margin,
            ...
            a;
        if (e < d) a = e / 2;
        else a = d / 2; if (this.expIndexes && this.expIndexes.length > 0) a -= this.explodedRadius;
        return a
    };
    ...
    R.prototype._render = function(v) {
        ...
        for (var o = this.chart.series._findStackedClusters(this, this.type), g = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), u = this.xAxisType, w = d.length, j = [], k = [], n = [], l, r, s, a, f, e, x, i, b = 0; b < w; b++) {
            ...
            var h = a.actualValue,
                p = this._getStackedTotal(g, c),
                q = h > 0 ? p.positive : p.negative,
                t = q != 0 ? 100 * Math.abs(h) / Math.abs(q) : 0;
            n.push({
                dataItem: a,
                index: b,
                x: i,
    ...
    K.prototype._renderCatData = function(E) {
        ...
        for (var B = [], A = [], t = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), K = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, h, e, d = 0; d < G; d++) {
            ...
            var o = this._getPrevStackedPosition(t, c.index, q, i, this.realYAxis, m >= 0),
                w = h,
                p;
            if (h <= o) p = o - h;
            else {
    ...
    K.prototype._renderLinearData = function(C) {
        ...
        var e = this.chart.series._findStackedClusters(this, this.type),
            o = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName),
            L = h.length,
            F = t.width / this.realXAxis.getZoom(),
            I = this._calcColumnScale(o) * F,
            n = this.pointWidth * I;
        ...
        for (var A = [], z = [], G = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, g, d, c = 0; c < L; c++) {
            ...
            var q = this._getPrevStackedPosition(o, e.index, s, i, this.realYAxis, m >= 0),
                v = g,
                r;
            if (g <= q) r = q - g;
            else {
            ...
            var p = d.actualValue,
                D = this._getStackedTotal(o, s),
                E = p > 0 ? D.positive : D.negative,
                x = E != 0 ? 100 * Math.abs(p) / Math.abs(E) : 0,
                u = {
                    chart: this.chart,
                    series: this,
                    dataItem: h[c],
            ...
            if (this.labels && this.labels.visible !== false && d.actualValue != 0) {
                ...
                var y = this.labels.position == "outside",
                    H = y ? G : -r / 2,
                    j = this._getDataPointLabel(d.actualValue, f, v, H, w);
    ...
    H.prototype._renderCatData = function(E) {
        ...
        for (var B = [], A = [], s = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), L = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, f, i, e, d = 0; d < H; d++) {
            ...
            var o = this._getPrevStackedPosition(s, c.index, p, j, this.realYAxis, m >= 0),
                w = f,
                q;
            if (f <= o) q = o - f;
            else {
    ...
    H.prototype._renderLinearData = function(C) {
        ...
        for (var A = [], z = [], H = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, e, n, d, c = 0; c < N; c++) {
            ...
            var p = this._getPrevStackedPosition(s, f.index, q, i, this.realYAxis, l >= 0),
                v = e,
                r;
            if (e <= p) r = p - e;
            else {
            ...
            var o = d.actualValue,
                D = this._getStackedTotal(s, q),
                F = o > 0 ? D.positive : D.negative,
                x = F != 0 ? 100 * Math.abs(o) / Math.abs(F) : 0,
                t = {
                    chart: this.chart,
                    series: this,
                    dataItem: h[c],
            ...
            if (this.labels && this.labels.visible !== false && d.actualValue != 0) {
                ...
                var y = this.labels.position == "outside",
                    I = y ? H : -r / 2,
                    g = this._getDataPointLabel(d.actualValue, v, n, I, w);
                if (!y) {
    ...
    F.prototype._render = function(q) {
        ...
        var r = this.chart.gridArea,
            k = j.length,
            d, f, h, g, e, m = r.width / this.realXAxis.getZoom(),
            i;
        if (this.xAxisType == "CategoryAxis") i = this.pointWidth * m / k;
        else {
    ...
    n.prototype._moveVisibleRange = function(f, g) {
        ...
        else a = d * f / this.length; if (this.reversed) a = -a;
    ...
    p.prototype._setMinMax = function(c, b) {
        ...
        else this.actualMinimum = c; if (this.maximum != null)
    ...
    p.prototype._calculateActualInterval = function(c, b) {
        ...
        else this.actualIntervalType = this.type; if (this.interval != null) a = this.interval;
        return a
    };
    ...
    p.prototype._getNextNonEmptyDay = function(b) {
        ...
        if (d == -1) return b;
        var h = g.addDays(new Date(b), 1),
            f = this.actualMaximum;
    ...
    C.prototype._getAngle = function(g) {
        var e = this.actualMaximum - this.actualMinimum,
            ...
            a;
        if (e === 0) a = c + d / 2;
        else a = c + d * (g - this.actualMinimum) / e; if (this.reversed === true) a = 2 * Math.PI - a;
        return a - Math.PI / 2
    };
